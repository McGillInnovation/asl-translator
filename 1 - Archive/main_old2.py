...
def make_network(x_train):
    ...
    # https://faroit.github.io/keras-docs/0.2.0/examples/
    # https://elitedatascience.com/keras-tutorial-deep-learning-in-python
    #model.add(Convolution2D(32, 3, 3, border_mode='same', input_shape=x_train.shape[1:])) <-- previously
    model.add(Convolution2D(32, (3, 3), padding='valid', activation='relu', input_shape=(400,400,3))) 
...
# def make_network used to be here!
# def trainData used to be here!
